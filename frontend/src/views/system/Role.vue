  ...
  <div class="container mt-3">
    <div class="card">
      <div class="card-header d-flex justify-content-between align-items-center">
        <h5 data-testid="role-management-title">角色管理</h5>
        <div class="d-flex">
          <div class="input-group me-2">
            ...
            >
            <button class="btn btn-outline-secondary" type="button" @click="loadRoles" v-permission="'system:role:view'" data-testid="role-search-btn">
      ...
      <div class="card-body" v-permission="'system:role:view'" data-testid="role-table-container">
          ...
          <table class="table table-striped table-hover">
            ...
            <tbody>
                ...
                <td>
                  <div class="btn-group">
                    ...
                    <button 
                      ...
                      :data-testid="'assign-permissions-btn-' + role.id"
                    >
                      <i class="bi bi-key"></i>
                    </button>
                  </div>
              ...
              <tr v-if="roles.length === 0">
                <td colspan="5" class="text-center" data-testid="no-roles-message">暂无数据</td>
              </tr>
            </tbody>
          </table>
        </div>
